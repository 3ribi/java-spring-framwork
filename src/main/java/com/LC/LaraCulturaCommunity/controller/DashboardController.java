...
public class DashboardController {
    ...
    private void logMessages() {
        ...
        log.error("defaultPageSize value with Environment is : "+environment.getProperty("laracultura.pageSize"));
        log.error("successMsg value with Environment is : "+environment.getProperty("laracultura.contact.successMsg"));
