...
import com.LC.LaraCulturaCommunity.service.ContactService;
...
public class ContactController {
    ...
    public String saveMessage(@Valid @ModelAttribute("contact") Contact contact, Errors errors) {
        ...
        return "redirect:/msg-succes";
    }

    @RequestMapping("/msgs/page/{pageNum}")
    ...
    public String closeMsg(@RequestParam int id) {
        ...
        return "redirect:/msgs/page/1?sortField=name&sortDir=desc";
    }
